...
st.write("This app predicts crop productivity based on temperature[cite: 18, 19].")
...
if os.path.exists(model_path):
    ...
    if st.button("Predict Yield"):
        ...
        st.info("Note: This prediction is based on the linear relationship between temperature and yield analyzed in your project.")
else:
